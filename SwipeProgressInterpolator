 ...
 */
final class SwipeProgressInterpolator implements Interpolator {
    private static final SwipeProgressInterpolator INSTANCE = new SwipeProgressInterpolator();

    public final static SwipeProgressInterpolator getInstance() {
        return INSTANCE;
    }
     ...
     */
    private SwipeProgressInterpolator() {
        super();
    }
